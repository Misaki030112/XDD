...
public class teacherDOExample {
    ...
    public teacherDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public teacherDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public teacherDOExample page(Integer page, Integer pageSize) {
