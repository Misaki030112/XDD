...
public class classroomDOExample {
    ...
    public classroomDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public classroomDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public classroomDOExample page(Integer page, Integer pageSize) {
