...
public class NewDOExample {
    ...
    public NewDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public NewDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public NewDOExample page(Integer page, Integer pageSize) {
