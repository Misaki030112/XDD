...
public class answerDOExample {
    ...
    public answerDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public answerDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public answerDOExample page(Integer page, Integer pageSize) {
