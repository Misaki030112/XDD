...
public class collegeDOExample {
    ...
    public collegeDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public collegeDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public collegeDOExample page(Integer page, Integer pageSize) {
