...
public class OperateLogDOExample {
    ...
    public OperateLogDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public OperateLogDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public OperateLogDOExample page(Integer page, Integer pageSize) {
