...
public class ChatMessageDOExample {
    ...
    public ChatMessageDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public ChatMessageDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public ChatMessageDOExample page(Integer page, Integer pageSize) {
