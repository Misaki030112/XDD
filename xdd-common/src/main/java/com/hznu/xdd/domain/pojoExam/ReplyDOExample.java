...
public class ReplyDOExample {
    ...
    public ReplyDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public ReplyDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public ReplyDOExample page(Integer page, Integer pageSize) {
