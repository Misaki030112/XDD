...
public class BoxRecordDOExample {
    ...
    public BoxRecordDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public BoxRecordDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public BoxRecordDOExample page(Integer page, Integer pageSize) {
