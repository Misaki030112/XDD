...
public class labelDOExample {
    ...
    public labelDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public labelDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public labelDOExample page(Integer page, Integer pageSize) {
