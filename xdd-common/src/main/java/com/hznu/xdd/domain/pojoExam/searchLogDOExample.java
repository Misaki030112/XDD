...
public class searchLogDOExample {
    ...
    public searchLogDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public searchLogDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public searchLogDOExample page(Integer page, Integer pageSize) {
