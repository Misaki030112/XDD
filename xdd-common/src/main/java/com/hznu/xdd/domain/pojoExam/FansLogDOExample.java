...
public class FansLogDOExample {
    ...
    public FansLogDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public FansLogDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public FansLogDOExample page(Integer page, Integer pageSize) {
