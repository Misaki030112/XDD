...
public class campusDOExample {
    ...
    public campusDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public campusDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public campusDOExample page(Integer page, Integer pageSize) {
