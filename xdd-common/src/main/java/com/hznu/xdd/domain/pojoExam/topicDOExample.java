...
public class topicDOExample {
    ...
    public topicDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public topicDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public topicDOExample page(Integer page, Integer pageSize) {
