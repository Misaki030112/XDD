...
public class schoolDOExample {
    ...
    public schoolDOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public schoolDOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public schoolDOExample page(Integer page, Integer pageSize) {
